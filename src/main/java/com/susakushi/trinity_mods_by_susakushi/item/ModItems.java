package com.susakushi.trinity_mods_by_susakushi.item;

import com.susakushi.trinity_mods_by_susakushi.TrinityModsbySusakushi;
import com.susakushi.trinity_mods_by_susakushi.curio.CurioBaseItem;
import com.susakushi.trinity_mods_by_susakushi.curio.SimpleAttributeCurio;
import com.susakushi.trinity_mods_by_susakushi.item.custom.*;
...
public class ModItems implements ICurioItem {
    ...
    public static final DeferredRegister<Item> ITEMS =
            DeferredRegister.create(ForgeRegistries.ITEMS, TrinityModsbySusakushi.MOD_ID);
