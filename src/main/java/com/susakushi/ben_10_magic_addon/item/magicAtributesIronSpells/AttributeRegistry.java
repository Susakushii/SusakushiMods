package com.susakushi.ben_10_magic_addon.item.magicAtributesIronSpells;
...
@Mod.EventBusSubscriber(modid = Ben_10_Magic_Addon.MOD_ID, bus = Mod.EventBusSubscriber.Bus.MOD)
public class AttributeRegistry {

    private static final DeferredRegister<Attribute> ATTRIBUTES = DeferredRegister.create(ForgeRegistries.ATTRIBUTES, Ben_10_Magic_Addon.MOD_ID);
