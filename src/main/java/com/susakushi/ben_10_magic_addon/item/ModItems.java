...
import com.susakushi.ben_10_magic_addon.curio.CurioBaseItem;
import com.susakushi.ben_10_magic_addon.curio.SimpleAttributeCurio;
import com.susakushi.ben_10_magic_addon.item.custom.*;
...
public class ModItems implements ICurioItem {
    ...
    public static final DeferredRegister<Item> ITEMS =
            DeferredRegister.create(ForgeRegistries.ITEMS, Ben_10_Magic_Addon.MOD_ID);
