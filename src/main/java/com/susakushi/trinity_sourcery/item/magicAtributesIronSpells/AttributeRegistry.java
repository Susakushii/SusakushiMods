...
public class AttributeRegistry {
    ...
    private static final DeferredRegister<Attribute> ATTRIBUTES = DeferredRegister.create(ForgeRegistries.ATTRIBUTES, com.susakushi.trinity_sourcery.TrinitySourcery.MOD_ID);
