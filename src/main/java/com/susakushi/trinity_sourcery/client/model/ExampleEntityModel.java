package com.susakushi.trinity_sourcery.client.model;// Made with Blockbench 4.9.4
...
import com.susakushi.trinity_sourcery.entity.animations.ModAnimationsDefinitions;
...
public class ExampleEntityModel<T extends ExampleEntity> extends HierarchicalModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(TrinitySourcery.MOD_ID, "example_entity"), "main");
