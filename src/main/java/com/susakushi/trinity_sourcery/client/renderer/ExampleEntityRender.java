package com.susakushi.trinity_sourcery.client.renderer;
...
public class ExampleEntityRender extends MobRenderer<ExampleEntity, ExampleEntityModel<ExampleEntity>> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(TrinitySourcery.MOD_ID, "textures/entity/example_entity2.png");
